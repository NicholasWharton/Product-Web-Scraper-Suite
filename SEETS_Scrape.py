...
#chrome driver located in C:\Windows directory
...
usernameInput.send_keys("INPUT USERNAME HERE")

passwordInput = driver.find_element(By.XPATH, '//*[@id="Password"]')
passwordInput.send_keys("INPUT PASSWORD HERE")
...
while(1):
    ...
    for items in range(int(maxItemsVal)):
        ...
        try:
            ...
            print("Failed to pull Item #" + str(count))
        finally:
            count += 1
    ...
    try:
        ...
        if (nextPage.text == '»'):
            ...
            print("Now Entering Page " + str(currPage))
        else:
            driver.quit()
            break
    except:
